...
public class AnnotatedForBounds {
	...
	// public final void testRangeDouble(@RangeDouble (min = -20, max = -1)
	// final Double d) {
	//
	// }
	//
	...
	// public final void testRangeInteger(@RangeInteger (min = 0, max = 5) final
	// Integer i) {
	//
	// }
	//
	...
	// public final void testRangeLong(@RangeLong (min = 2l, max = 4l) final
	// Long l) {
	//
	// }
	//
