...
/**
 * Annotation to assert a string is either empty or consists only of alpha-numeric characters. If the string is null,
 * the annotation will <b>not</b> trigger a violation. If you want the string also be checked to be not null use the
 ...
 * 
 * <pre>
 * public void someFunction(@AlphaNumString final String string) {
 * 	...
 * }
 * </pre>
 * 
 ...
 * </dt> </dl>
 * 
 * @see StringCondition#alphanum(String, String, Object...)
 * 
 * @see AlphaNumString
 * @see AlphaString
 * @see AsciiString
