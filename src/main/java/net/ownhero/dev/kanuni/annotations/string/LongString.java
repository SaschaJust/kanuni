 ...
 * 
 * <pre>
 * public void someFunction(@LongString final String string) {
 * 	...
 * }
 * </pre>
 * 
 ...
 * public class A {
 * 	
 * 	A(@LongString(&quot;According to spec 123.45 the submitted string has to represent a long.&quot;) 
 * 	                  final String string) {
 * 		...
 * 	}
 * }
 ...
 * 		StringCondition.alphanum(string, &quot;According to spec 123.45 the submitted string has to represent a long.&quot;);
 * 		...
 * 	}
 * }
 * 
...
@ConditionPattern ("StringCondition.isLong($pname$, $value$, new Object[0])")
