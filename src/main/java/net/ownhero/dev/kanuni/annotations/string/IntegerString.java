 ...
 * 
 * <pre>
 * public void someFunction(@IntegerString final String string) {
 * 	...
 * }
 * </pre>
 * 
 ...
 * public class A {
 * 	
 * 	A(@IntegerString(&quot;According to spec 123.45 the submitted string has to represent an integer.&quot;) 
 * 	                  final String string) {
 * 		...
 * 	}
 * }
 ...
 * 		StringCondition.alphanum(string, &quot;According to spec 123.45 the submitted string has to represent an integer.&quot;);
 * 		...
 * 	}
 * }
 * 
