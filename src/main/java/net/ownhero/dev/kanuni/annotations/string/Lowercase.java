 ...
 * 
 * <pre>
 * public void someFunction(@LowercaseString final String string) {
 * 	...
 * }
 * </pre>
 * 
 ...
 * public class A {
 * 	
 * 	A(@LowercaseString(&quot;According to spec 123.45 the submitted string has to be lowercase.&quot;) 
 * 	                  final String string) {
 * 		...
 * 	}
 * }
 ...
 * 		StringCondition.alphanum(string, &quot;According to spec 123.45 the submitted string has to be lowercase.&quot;);
 * 		...
 * 	}
 * }
 * 
...
@ConditionPattern ("StringCondition.lowercase($pname$, $value$, new Object[0])")
