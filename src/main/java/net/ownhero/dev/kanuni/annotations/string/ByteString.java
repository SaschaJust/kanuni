 ...
 * public class A {
 * 	
 * 	A(@ByteString(&quot;According to spec 123.45 the submitted string has to consist only of bytes.&quot;) 
 * 	                  final String string) {
 * 		...
 * 	}
 * }
 ...
 * 		StringCondition.alphanum(string, &quot;According to spec 123.45 the submitted string has to consist only of bytes.&quot;);
 * 		...
 * 	}
 * }
 * 
...
@ConditionPattern ("StringCondition.isByte($pname$, $value$, new Object[0])")
