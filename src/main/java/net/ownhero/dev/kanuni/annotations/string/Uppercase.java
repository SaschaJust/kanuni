 ...
 * 
 * <pre>
 * public void someFunction(@UppercaseString final String string) {
 * 	...
 * }
 * </pre>
 * 
 ...
 * public class A {
 * 	
 * 	A(@UppercaseString(&quot;According to spec 123.45 the submitted string has to be uppercase.&quot;) 
 * 	                  final String string) {
 * 		...
 * 	}
 * }
 ...
 * 		StringCondition.alphanum(string, &quot;According to spec 123.45 the submitted string has to be uppercase.&quot;);
 * 		...
 * 	}
 * }
 * 
...
@ConditionPattern ("StringCondition.uppercase($pname$, $value$, new Object[0])")
