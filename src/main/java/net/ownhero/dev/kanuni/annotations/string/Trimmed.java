 ...
 * string. If the string is null, the annotation will <b>not</b> trigger a
 ...
 * 
 * <pre>
 * public void someFunction(@TrimmedString final String string) {
 * 	...
 * }
 * </pre>
 * 
 ...
 * public class A {
 * 	
 * 	A(@TrimmedString(&quot;According to spec 123.45 the submitted string has to be trimmed.&quot;)
 * 	                  final String string) {
 * 		...
 * 	}
 * }
 ...
 * 		StringCondition.alphanum(string, &quot;According to spec 123.45 the submitted string has to be trimmed.&quot;);
 * 		...
 * 	}
 * }
 * 
