...
/**
 * The Class CreatorSize.
 *
 * @author Sascha Just <sascha.just@own-hero.net>
 */
public final class CreatorSize extends Creator {
	...
	public String createParameterInstrumentation(final Annotation annotation,
		...
		IntegerMemberValue sizeMemberValue = (IntegerMemberValue) KanuniInstrumenter.getMemberValue(annotation, "size");
