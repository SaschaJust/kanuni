 ...
 * 
 * <pre>
 * public void someFunction(@HexString final String string) {
 * 	...
 * }
 * </pre>
 * 
 ...
 * public class A {
 * 	
 * 	A(@HexString(&quot;According to spec 123.45 the submitted string has to be hexadecimal.&quot;) 
 * 	                  final String string) {
 * 		...
 * 	}
 * }
 ...
 * 		StringCondition.alphanum(string, &quot;According to spec 123.45 the submitted string has to be hexadecimal.&quot;);
 * 		...
 * 	}
 * }
 * 
...
@ConditionPattern ("hex($pname$, $value$, new Object[0])")
