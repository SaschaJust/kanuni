 ...
 * public class A {
 * 	
 * 	A(@DigitString(&quot;According to spec 123.45 the submitted string has to consist only of digits.&quot;) 
 * 	                  final String string) {
 * 		...
 * 	}
 * }
 ...
 * 		StringCondition.alphanum(string, &quot;According to spec 123.45 the submitted string has to consist only of digits.&quot;);
 * 		...
 * 	}
 * }
 * 
...
@ConditionPattern ("StringCondition.digit($pname$, $value$, new Object[0])")
