...
/**
 * Annotation to assert a string is either empty or consist on of digits. If the string is null, the annotation will
 ...
 * 
 * <pre>
 * public void someFunction(@DigitString final String string) {
 * 	...
 * }
 * </pre>
 * 
 ...
 * public class A {
 * 	
 * 	A(@DigitString(&quot;According to spec 123.45 the submitted string has to only consist of digits.&quot;)
 * 	                  final String string) {
 * 		...
 * 	}
 * }
 ...
 * 		StringCondition.digit(string, &quot;According to spec 123.45 the submitted string has to only consist of digits.&quot;);
 * 		...
 * 	}
 * }
 * 
 ...
 * </dt></dl>
 * 
 * @see StringCondition#digit(String, String, Object...)
 * 
 * @see AlphaNumString
 * @see AlphaString
 * @see AsciiString
