...
import net.ownhero.dev.kanuni.exceptions.violations.ArrayContainsViolation;
import net.ownhero.dev.kanuni.exceptions.violations.ArrayEmptyViolation;
import net.ownhero.dev.kanuni.exceptions.violations.ArrayMaxSizeViolation;
import net.ownhero.dev.kanuni.exceptions.violations.ArrayMinSizeViolation;
import net.ownhero.dev.kanuni.exceptions.violations.ArrayNoneNullViolation;
import net.ownhero.dev.kanuni.exceptions.violations.ArrayNotEmptyViolation;
import net.ownhero.dev.kanuni.exceptions.violations.ArraySameSizeViolation;
import net.ownhero.dev.kanuni.exceptions.violations.ArraySizeViolation;
import net.ownhero.dev.kanuni.exceptions.violations.ArrayValidIndexViolation;
...
public class ArrayCheck {
	...
	public static final void contains(final Object array,
		...
		if (KanuniInstrumenter.exceptionsEnabled()) {
			if (array == null) {
				throw new ArrayContainsViolation(Check.getCallerString()
	...
	public static final void empty(final Object array,
		...
		if (KanuniInstrumenter.exceptionsEnabled()) {
			if (array == null) {
				throw new ArrayEmptyViolation(Check.getCallerString()
			...
			if (Array.getLength(array) != 0) {
				throw new ArrayEmptyViolation(
				                              Check.getCallerString()
				                                      + String.format("Container is not empty. Violation: %s",
				                                                      String.format(formatString, arguments)));
			}
		}
	}
	...
	public static final void maxSize(final Object array,
		...
		if (KanuniInstrumenter.exceptionsEnabled()) {
			if (array == null) {
				throw new ArrayMaxSizeViolation(Check.getCallerString()
			...
			if (!array.getClass().isArray()) {
				throw new ArrayMaxSizeViolation(
				                                Check.getCallerString()
	...
	public static final void noneNull(final Object array,
		...
		if (KanuniInstrumenter.exceptionsEnabled()) {
			...
			if (array == null) {
				throw new ArrayNoneNullViolation(
				                                 Check.getCallerString()
			...
			if (CollectionUtils.countMatches(Arrays.asList(array),
				...
				throw new ArrayNoneNullViolation(Check.getCallerString()
	...
	public static final void notEmpty(final Object array,
		...
		if (KanuniInstrumenter.exceptionsEnabled()) {
			...
			if (array == null) {
				throw new ArrayNotEmptyViolation(Check.getCallerString()
				        + String.format("Argument is null, but should be a none empty array . Violation: %s",
				                        String.format(formatString, arguments)));
			}
	...
	public static final void sameSize(final Object firstArray,
		...
		if (KanuniInstrumenter.exceptionsEnabled()) {
			...
			if (firstArray == null) {
				throw new ArraySameSizeViolation(
				                                 Check.getCallerString()
	...
	public static final void size(final Object array,
		...
		if (KanuniInstrumenter.exceptionsEnabled()) {
			...
			if (array == null) {
				throw new ArraySizeViolation(Check.getCallerString()
				        + String.format("Argument is null, but should be an array with maximum size %s. Violation: %s",
				                        length, String.format(formatString, arguments)));
			}
			
			if (!array.getClass().isArray()) {
				throw new ArraySizeViolation(
				                             Check.getCallerString()
				                                     + String.format("Argument is not an array, but should be an array with maximum size %s. Violation: %s",
				                                                     length, String.format(formatString, arguments)));
			}
	...
	public static final void validIndex(final Object array,
		...
		if (KanuniInstrumenter.exceptionsEnabled()) {
			...
			if (array == null) {
				throw new ArrayValidIndexViolation(
				                                   Check.getCallerString()
			...
			if (index < 0) {
				throw new ArrayValidIndexViolation(Check.getCallerString()
			...
			if (Array.getLength(array) <= index) {
				throw new ArrayValidIndexViolation(Check.getCallerString()
				        + String.format("Container index not in bounds (0..%s): %s. Violation: %s",
				                        Array.getLength(array), index, String.format(formatString, arguments)));
