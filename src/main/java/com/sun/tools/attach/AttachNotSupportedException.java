...
/**
 * Thrown by {@link VirtualMachine#attach VirtalMachine.attach} when attempting to attach to a Java virtual machine for
 * which a compatible {@link com.sun.tools.attach.spi.AttachProvider AttachProvider} does not exist. It is also thrown
 * by {@link com.sun.tools.attach.spi.AttachProvider#attachVirtualMachine AttachProvider.attachVirtualMachine} if the
 * provider attempts to attach to a Java virtual machine with which it not compatible.
 */
public final class AttachNotSupportedException extends Exception {
	...
	/**
	 * Constructs an <code>AttachNotSupportedException</code> with the specified detail message.
	 * 
	 * @param s
	 *            the detail message.
	 */
