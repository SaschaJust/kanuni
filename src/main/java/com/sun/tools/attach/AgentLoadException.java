 ...
 * <p/>
 * <p>
 * This exception is thrown by {@link VirtualMachine#loadAgent VirtualMachine.loadAgent} or
 * {@link VirtualMachine#loadAgentLibrary VirtualMachine.loadAgentLibrary}, {@link VirtualMachine#loadAgentPath
 * loadAgentPath} methods if the agent, or agent library, cannot be loaded.
 */
public final class AgentLoadException extends Exception {
	...
	/**
	 * Constructs an <code>AgentLoadException</code> with no detail message.
	 */
